...
class _AllStudentsState extends State<AllStudents> {
  ...
  static const List<String> semesterList = <String>[
    '',
    '1st Semester',
    '2nd Semester',
    'Mid-year'
  ...
  void filterBySemester(String semester) {
    setState(() {
      filteredInterns = semester.isEmpty
          ? interns
          : interns.where((intern) => intern.semester == semester).toList();
    });
  }

  void filterByYear(String sy) {
    setState(() {
      filteredInterns = sy.isEmpty
          ? interns
          : interns.where((intern) => intern.school_year == sy).toList();
    });
  }
