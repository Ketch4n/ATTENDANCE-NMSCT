...
Future<void> editSchoolYear(
    BuildContext context, int id, String sy, Function reload) async {
  if (sy.isEmpty) {
  ...
  try {
    final response = await http.post(
      Uri.parse(
          "${Server.host}users/establishment/school_year/edit_school_year.php"),
      body: json.encode({"id": id, "school_year": sy}),
    );
